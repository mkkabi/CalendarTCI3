...
public class TeacherServiceImpl implements TeacherService {
    ...
    public List<Teacher> getAll() {
        ...
        return teachers.isEmpty() ? new ArrayList<>() : teachers;
    }

    @Transactional
    @Override
    public List<TeacherDto> getAllAsDto() {
        return getAll().stream().map(TeacherDtoTransformer::convertToDto).collect(Collectors.toList());
    }

    @Transactional
    @Override
    public List<Teacher> findActiveTeachersForGroup(long id) {
